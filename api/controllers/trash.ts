...
export const getAllTrash = async (req: any, res: Response) => {
  try {
...
export const recoverNoteById = async (req: any, res: Response) => {
...
export const deleteNoteByIdPermantly = async (req: any, res: Response) => {
  if (!mongoose.Types.ObjectId.isValid(req.params.id))
    return res.status(400).json({ error: "Invalid note id" });
